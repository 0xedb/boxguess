            ...
            <table className="table-auto border-spacing-x-5 border-spacing-y-2 border border-slate-300">
              ...
              <tbody>
                ...
                <tr className="border border-slate-300">
                  ...
                  <td className="border border-slate-300 p-3">12.50:87.50</td>
                  <td className="border border-slate-300 p-3">5.5x Bid</td>
                  <td className="border border-slate-300 p-3">+55 hbar</td>
                  <td className="border border-slate-300 p-3">+2750 hbar</td>
                  <td className="border border-slate-300 p-3">+0.275 sol</td>
                  <td className="border border-slate-300 p-3">+11 sol</td>
                </tr>
                <tr className="border border-slate-300">
